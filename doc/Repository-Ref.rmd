...
* **/SPARQL**
    * SPARQL scripts for working with the data in the triplestore.
      All scripts must contain a comment header describing their function.
      Files may contain multiple independent scripts, like MiscQueries.rq.
      Scripts should indicate SPARQL extensions specific to Stardog whenever used.
...
* **/r/vis**
    ...
    * /archive  - code that should be deleted
