...
* **cdiscpilot01-protocol.ttl**
    - Protocol information for the pilot study. Includes arm resources and custom analyses. Protocol-specific items are added to the cdiscpilot01-protocol.ttl file which is customized for each study. Also used in DEFINE XML generation.
