...
**CAUTION: If you are reading this document outside of the R environment, the information is likely out of date! See the .rmd file in the project's Github root /CTDasRDF folder for the latest information.**
...
# Data Files
## SDTM Data Sources
SDTM XPT data files were obtained from the PhUSE CDISCPILOT01 study, here: https://github.com/phuse-org/phuse-scripts/blob/master/data/sdtm/cdiscpilot01/

Data augmentation for development and testing occurs in files named with \<domain name\>_impute.R. As a result, data files created during conversion will not be an exact match with the original .XPT source files.
