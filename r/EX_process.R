...
#      object    = paste0(CDISCPILOT01, ex$XXXXXXXX_Frag)))
      ...
      #      subject   = paste0(CDISCPILOT01, ex$XXXXXXXX_Frag),
      #      predicate = paste0(SKOS, "prefLabel"),
      #      object    = paste0("Fixed dose interval", XXXXXX),
      #         objectType = "literal", datatype_uri = paste0(XSD,"string")))
      ...
      #      object    = paste0(CDISCPILOT01, ex$endtc_Frag")))
